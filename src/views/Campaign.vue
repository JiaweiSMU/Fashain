<template>
    <NavBar />
    <div id="app" class="formbold-main-wrapper">
        <!-- Author: FormBold Team -->
        <!-- Learn More: https://formbold.com -->
        <div class="formbold-form-wrapper">
            <div class="formbold-event-wrapper">
                <span>Fashain</span>
                <h3>Create your own campaign now!</h3>
                <!--<form>-->
                <!-- Campaign Name -->
                <div class="formbold-input-flex">
                    <div>
                        ...
                        <input v-model="campaignName" type="text" name="firstname" id="firstname"
                ...
                <div class="formbold-input-flex">
                    <div>
                        ...
                        <input v-model="campaignStartDate" type="date" name="dob" id="dob" class="formbold-form-input" />
                    </div>
                    <div>
                ...
                <button @click="submit()" class="formbold-btn">Submit Campaign Creation</button>
                <!--</form>-->
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
         ...
         *
         * @return {boolean} Returns true if the campaign end date is greater than or equal to the campaign start date, otherwise returns false.
         */
        checkDate() {
            var before = this.campaignStartDate;
            var after = this.campaignEndDate;
        ...
        /**
         * Submits the form and performs some validations.
         *
         */
        submit() {
            let listOfErrors = [];
            if (this.checkDate() == false) {
                ...
                listOfErrors.push('Invalid date');
        ...
        handleImageUpload(image) {
            ...
            // let filename = this.uploadedImage.name;
         ...
         * @return {boolean} Returns true if the image is valid, false otherwise.
         */
        isImageValid(image) {
